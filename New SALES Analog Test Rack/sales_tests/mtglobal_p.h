...
#define PS		"GPIB0::8::INSTR"	//Power Supply 6634B//sri- 28th Feb 2007-changed to 8 from 5.
...
#define OLYM	"GPIB0::11::INSTR"	//N6700B or N6700C System Power Supply(N6776A)
#define PS_N6746B "GPIB0::11::INSTR" //N6746B-replacement for 6634B
#define PS_N6754A "GPIB0::5::INSTR" //N6754A-replacement for 6038A
...
#define WAIT_TIME_FOR_RELAYS  1.0e-03
  ...
  #define WAIT_TIME_FOR_RELAYS_OPEN  3.0e-03  //3-feb-2023
//#define WAIT_TIME_FOR_RELAYS_OPEN  2.0   //3.0e-03 to 2.0s
...
void connect_minus_xn_plus_2(int mod_id, int channel, int status);//chun 16032022
...
void connect_power_supply_xmint_PS6634B(int mod_id); //fikri add for PS6634B 31/01/2023
...
void setup_E4980AL_LCR(int mod_id, int lcr_function, int lcr_display, int lcr_ckt_mode, double lcr_freq, int lcr_mult);
...
void open_PS_N6754A_load(int mod_id);//chun
...
void close_34980A(int mod_id);//chun12112021
void connect_34980A_relay(int connection);//chun19112021
boolean get_34980A_IDN(void);//chun22112021
void disconnect_34980A_relay(int connection);//22112021
void open_53230A(int mod_id);
...
void setup_counter_53230A_init(void);
void setup_counter_53230A_abort(void);
...
void setup_N6746B_ch2_output(int x);//chun 20052022
void setup_N6754A_ch1_output(int x);
void setup_N6746B_ch2_delay(double x);//chun 20052022
void setup_N6746B_ch2_volt(int mod_id, double amplitude);//chun 20052022
void setup_N6746B_ch2_curr(int mod_id, double amplitude);//chun 20052022
boolean get_53230A_IDN(void);//chun 17052022
...
void verify_PS_N6754A_output_load(int mod_id, double diff, double ramp_time, double expected_volts);
